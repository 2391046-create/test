    ...
    <ScreenContainer className="px-5 pt-4">
      <View className="flex-1 gap-4">
        ...
        <View className="gap-2 mb-2">
          ...
          <Text className="text-sm text-muted">모든 거래 내역을 확인하고 관리하세요</Text>
        </View>
        ...
        <View className="gap-3">
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} className="gap-2">
            <Pressable
              ...
              className={`rounded-full px-4 py-2 border ${selectedCategory === null ? 'bg-primary border-primary' : 'border-border bg-surface'}`}
            >
            ...
            {categories.map((cat) => (
              <Pressable
                ...
                style={({ pressed }) => [{ opacity: pressed ? 0.7 : 1 }]}
                className={`rounded-full px-4 py-2 border ${selectedCategory === cat.id ? 'border-primary bg-primary/10' : 'border-border bg-surface'}`}
              >
                ...
                <View className="flex-row items-start justify-between gap-3">
                  <View className="flex-row items-center gap-3 flex-1">
                    ...
                    <View className="flex-1">
                      <Text className="text-sm font-bold text-foreground">{item.merchant}</Text>
                  ...
                  <View className="items-end">
                    ...
                    <Text className="text-xs text-muted">{item.currency}</Text>
                  </View>
                </View>
                {item.confidence < 0.9 && (
