...
=======
      Alert.alert("오류", "최소 1명 이상의 인원을 추가해주세요");
      return;
    }
    if (totalAmount === 0) {
      Alert.alert("오류", "총액을 입력해주세요");
>>>>>>> main
      return;
    }
...
=======
          <Text className="text-3xl font-bold text-foreground">더치페이 정산</Text>
          <Text className="text-sm text-muted">여러 명의 결제 금액을 공정하게 정산</Text>
>>>>>>> main
        </View>
...
=======
          <Text className="text-lg font-semibold text-foreground">총 결제 금액</Text>
>>>>>>> main
...
=======
              <Text className="font-semibold text-background">설정</Text>
            </TouchableOpacity>
          </View>
          {totalAmount > 0 && (
            <Text className="text-sm text-success">✓ 총액: ₩{totalAmount.toLocaleString()}</Text>
>>>>>>> main
          )}
        </View>
...
=======
          <Text className="text-lg font-semibold text-foreground">참가자 ({members.length}명)</Text>
>>>>>>> main
          <View className="flex-row gap-2">
            <TextInput
              value={newMemberName}
...
=======
              <Text className="font-semibold text-background">추가</Text>
>>>>>>> main
            </TouchableOpacity>
          </View>
        </View>
...
=======
                      <Text className="text-xs text-muted">낸 금액</Text>
>>>>>>> main
                      <TextInput
...
=======
            <Text className="text-center font-semibold text-background text-lg">정산 계산</Text>
>>>>>>> main
          </TouchableOpacity>
        )}
...
=======
            <Text className="text-lg font-semibold text-foreground">정산 결과</Text>

            {/* 1인당 금액 */}
            <View className="p-4 bg-primary rounded-lg">
              <Text className="text-sm text-background">1인당 부담액</Text>
>>>>>>> main
...
=======
                <Text className="text-base font-semibold text-foreground">정산 내역</Text>
>>>>>>> main
...
=======
              ...
              <TouchableOpacity onPress={handleReset} className="p-4 bg-surface border border-border rounded-lg">
                <Text className="text-center font-semibold text-foreground">다시 계산</Text>
>>>>>>> main
              </TouchableOpacity>
            </View>
          </View>
