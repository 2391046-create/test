    ...
    <ScreenContainer className="p-4">
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="gap-6">
       ...
       <TouchableOpacity
        ...
        >
          <Text className="text-sm font-semibold text-foreground">분류 규칙</Text>
          <Text className="text-xs text-muted">결제 알림 자동 분류 규칙을 관리합니다</Text>
          <Text className="text-xs text-primary font-semibold mt-1">규칙 관리 열기 →</Text>
        </TouchableOpacity>
        ...
        <View className="gap-2 p-4 bg-surface rounded-lg border border-border">
          ...
          <Text className="text-xs text-muted">유학생 재정 관리 및 XRPL 블록체인 기반 생활비 송금/환전 앱</Text>
        </View>
      </ScrollView>
    </ScreenContainer>
  );
